...
INSERT IGNORE INTO persona (nombres, apellidos, email) VALUES 
...
INSERT IGNORE INTO facultad (nombre, decano) VALUES 
...
INSERT IGNORE INTO programa (nombre, duracion, registro, facultad) VALUES 
...
-- 4. Insertar Cursos
INSERT IGNORE INTO curso (nombre, programa, activo) VALUES 
...
INSERT IGNORE INTO profesor (id, tipo_contrato) VALUES 
    (1, 'TIEMPO_COMPLETO'),
    (2, 'TIEMPO_COMPLETO'),
    (3, 'CATEDRA'),
    (4, 'TIEMPO_COMPLETO'),
...
INSERT IGNORE INTO estudiante (id, codigo, programa, activo, promedio) VALUES 
...
INSERT IGNORE INTO curso_profesor (profesor, curso, anio, semestre) VALUES 
    (1, 1, 2024, 1),
    (1, 2, 2024, 1),
    (2, 3, 2024, 1),
    (3, 4, 2024, 1),
...
INSERT IGNORE INTO inscripcion (curso, estudiante, anio, semestre) VALUES 
    (1, 7, 2024, 1),
    (2, 7, 2024, 1),
    (3, 8, 2024, 1),
    (1, 8, 2024, 1),
